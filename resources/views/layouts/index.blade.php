                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">Daisy Anderson <span
                                                    class="msg-time float-right">5 sec
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">Oscar Garner <span
                                                    class="msg-time float-right">8 min
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">Amelia Doe <span
                                                    class="msg-time float-right">22 min
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">Cristina Jhons <span
                                                    class="msg-time float-right">2 hrs
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">James Caviness <span
                                                    class="msg-time float-right">4 hrs
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">Peter Costanzo <span
                                                    class="msg-time float-right">6 hrs
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">Thomas Wheeler <span
                                                    class="msg-time float-right">2 days
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">Johnny Seitz <span
                                                    class="msg-time float-right">5 days
                                                    ago</span></h6>
                            ...
                            <div class="header-notifications-list">
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">New Customers<span
                                                    class="msg-time float-right">14 Sec
                                                    ago</span></h6>
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">New Orders <span class="msg-time float-right">2
                                                    min
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">24 PDF File<span
                                                    class="msg-time float-right">19 min
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">Time Response <span
                                                    class="msg-time float-right">28 min
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">New 24 authors<span
                                                    class="msg-time float-right">1 day
                                                    ago</span></h6>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="msg-name">Defense Alerts <span
                                                    class="msg-time float-right">2 weeks
                                                    ago</span></h6>
                            ...
                            <div class="legends">
                                <div class="row">
                                    <div class="col-12 col-lg-5">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="text-secondary"><i
                                                    class='bx bxs-circle font-13 text-primary-blue mr-2'></i>Desktop
                                            </div>
                                            <div>$850.04</div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="text-secondary"><i
                                                    class='bx bxs-circle font-13 text-shineblue mr-2'></i>Mobile</div>
                                            <div>$755.08</div>
                                    ...
                                    <div class="col-12 col-lg-5">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="text-secondary"><i
                                                    class='bx bxs-circle font-13 text-primary mr-2'></i>Tablet</div>
                                            <div>$687.03</div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="text-secondary"><i
                                                    class='bx bxs-circle font-13 text-red mr-2'></i>Unknown</div>
                                            <div>$142.07</div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="d-flex align-items-center"><i
                                                    class="flag-icon flag-icon-um mr-2"></i>
                                        ...
                                        <tr>
                                            <td class="d-flex align-items-center"><i
                                                    class="flag-icon flag-icon-nl mr-2"></i>
                                                <div>Netherlands</div>
                                            </td>
                                            <td>11,495</td>
                                        ...
                                        <tr>
                                            <td class="d-flex align-items-center"><i
                                                    class="flag-icon flag-icon-ca mr-2"></i>
                                                <div>Canada</div>
                                            </td>
                                            <td>07,845</td>
                                        ...
                                        <tr>
                                            <td class="d-flex align-items-center"><i
                                                    class="flag-icon flag-icon-au mr-2"></i>
                                                <div>Australia</div>
                                            </td>
                                            <td>05,945</td>
                        ...
                        <div class="card radius-15">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <p class="mb-0 ml-auto"><i
                                            class="bx bx-dots-horizontal-rounded float-right font-24"></i>
                                    </p>
                                </div>
                                <div class="media align-items-center mt-3">
                                    <img src="https://via.placeholder.com/110x110" width="45" height="45"
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="product-img bg-transparent border">
                                                <img src="/images/icons/smartphone.png" width="35" alt="">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-img bg-transparent border">
                                                <img src="/images/icons/watch.png" width="35" alt="">
                                            </div>
                                        </td>
                                        <td>Hand Watch</td>
                                        <td>Milona Burke</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-img bg-transparent border">
                                                <img src="/images/icons/laptop.png" width="35" alt="">
                                            </div>
                                        </td>
                                        <td>Mini Laptop</td>
                                        <td>Craig Clayton</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-img bg-transparent border">
                                                <img src="/images/icons/shirt.png" width="35" alt="">
                                            </div>
                                        </td>
                                        <td>Slim-T-Shirt</td>
                                        <td>Clark Andola</td>
