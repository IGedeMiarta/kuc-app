@extends('layouts.dashboard.dashboardmain')
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ml-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item"
                            ...
                            <div class="dropdown-divider"></div> <a class="dropdown-item" href="javascript:;">Something
                                else here</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="legends">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="text-secondary"><i class='bx bxs-circle font-13 text-primary mr-2'></i>Tablet
                                </div>
                                <div>$687.03</div>
                            ...
                            <div class="my-2"></div>
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="text-secondary"><i class='bx bxs-circle font-13 text-red mr-2'></i>Unknown
                                </div>
                                <div>$142.07</div>
            ...
            <div class="card radius-15">
                <div class="card-body">
                    ...
                    <div class="media align-items-center mt-3">
                        <img src="https://via.placeholder.com/110x110" width="45" height="45" class="rounded-circle"
                            alt="">
